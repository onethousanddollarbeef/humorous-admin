    ...
    return (
        <main className="grid" style={{ gap: 16 }}>
            ...
            <section className="grid stats">
                <div className="card"><h3>Total Profiles</h3><p>{users ?? 0}</p></div>
                <div className="card"><h3>Total Images</h3><p>{images ?? 0}</p></div>
                <div className="card"><h3>Total Captions</h3><p>{captions ?? 0}</p></div>
                <div className="card"><h3>Caption Requests</h3><p>{requests ?? 0}</p></div>
                <div className="card"><h3>Terms</h3><p>{terms ?? 0}</p></div>
                <div className="card"><h3>LLM Models</h3><p>{models ?? 0}</p></div>
                <div className="card"><h3>Allowed Domains</h3><p>{domains ?? 0}</p></div>
                <div className="card"><h3>Upload Tempo</h3><p>{burstiness}</p></div>
            </section>
            ...
            <section className="card">
                ...
                <table className="table">
                    <thead>
                    <tr><th>Image ID</th><th>Owner ID</th><th>Created</th></tr>
                    </thead>
                    <tbody>
